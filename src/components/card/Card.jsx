    ...
    return (
        <div className="card mb-10 mt-10">
            <div className="item-box flex justify-center flex-wrap gap-4">
                {precos.map((item, i) => (
                    <div key={i} className="border rounded-3xl p-4 h-[380px] shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
                        <h1 className="text-[22px] font-medium text-center">{i > 0 ? <span>{item.dias} Dias</span> : <span>{item.dias} Dia</span>} | 2 Horas</h1>
                        <div className="day mt-4 pb-4 border-b-4">
                            <h3 className="text-xl font-semibold border bg-cyan-700 text-white text-center mb-2">1 Curso</h3>
                            ...
                            <p>Mensalidade: <span className="font-semibold">R$ {item.mensalidade},00</span></p>
                        </div>
                        <div className="moreDays mt-4">
                            ...
                            <div>
                                ...
                                <p>Desconto de Pontualidade: <span className="font-semibold">R$ {item.descPontualidade},00</span></p>
                                <p className="text-center mt-5">Mensalidade: <span className="font-semibold">R$ {item.promoMensalidade},00</span></p>
                            </div>
                        </div>
                    </div>
                ))}
